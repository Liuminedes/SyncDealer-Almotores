  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      <Dialog
        ...
        fullScreen={isMobile}
        PaperProps={{
          sx: { borderRadius: isMobile ? 0 : 1, overflow: "hidden" },
        }}
      >
        <DialogTitle
          sx={{
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      onChange={(e) =>
                        setFormUser({ document_number: e.target.value })
                      }
                    />
                  </Grid>
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      onChange={(e) =>
                        setFormUser({ branch_id: e.target.value })
                      }
                    >
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      onChange={(e) =>
                        setFormUser({ hire_date: e.target.value })
                      }
                    />
                  </Grid>
                </Grid>
