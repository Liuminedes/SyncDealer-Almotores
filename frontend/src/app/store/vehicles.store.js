...
function getRate(veh, key) {
    ...
    if (Array.isArray(rates)) {
        const hit = rates.find((r) => String(r.tier_name || r.tier || "").toUpperCase() === key);
...
export const useVehiclesStore = create((set, get) => ({
    ...
    openEdit: async (vehicle) => {
        set({ openForm: true, formMode: "edit", formVehicle: null, isSaving: false, error: null });
        try {
            ...
            set({
                formVehicle: {
                    ...
                    rates: {
                        TABLA_1: rate1 || (typeof rates?.TABLA_1 !== "undefined" ? rates.TABLA_1 : ""),
                        TABLA_2: rate2 || (typeof rates?.TABLA_2 !== "undefined" ? rates.TABLA_2 : ""),
                        TABLA_3: rate3 || (typeof rates?.TABLA_3 !== "undefined" ? rates.TABLA_3 : ""),
                    },
                },
            });
        } catch (e) {
