...
import AdvisorVacation from "./AdvisorVacation.js";
...
User.belongsToMany(Brand, { through: UserBrandAccess, foreignKey: "user_id",  otherKey: "brand_id" });
Brand.belongsToMany(User, { through: UserBrandAccess, foreignKey: "brand_id", otherKey: "user_id"  });

UserBrandAccess.belongsTo(User,  { as: "user",  foreignKey: "user_id"  });
UserBrandAccess.belongsTo(Brand, { as: "brand", foreignKey: "brand_id" });

// AdvisorVacation ↔ User
User.hasMany(AdvisorVacation,          { as: "vacations",  foreignKey: "advisor_id" });
AdvisorVacation.belongsTo(User,        { as: "advisor",    foreignKey: "advisor_id" });
...
export {
  sequelize,
  User, Role, Brand, Branch, UserBrandAccess,
  AdvisorVacation,
  Vehicle, Sale,
  CommissionRun, CommissionStatementItem,
  CommissionScheme, CommissionTier,
  SchemeRule, SchemeBonus,
};